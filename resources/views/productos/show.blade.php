            ...
            <div class="col-md-5">
                <div class="card shadow-lg p-3 mb-5 bg-white rounded">
                    <div class="card-header text-center">                    
                        <p class="h3 font-weight-light text-secondary text-center">{{$producto->nombreProducto}} ${{$producto->precio}}</p>
                    </div>
                    <div class="card-body">
                    <?php 
                    ...
                    ?>
                    <br>
                    <p class="h4 font-weight-light text-secondary text-left mt-1">Contacto</p>
                    <p style="font-size: 18px;">
                        <i class="ml-5"><?php  echo str_replace('"', "", json_encode($data[0]->name)); ?></i>
                        <br>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-envelope-fill mr-3" viewBox="0 0 16 16">
                          ...
                          <?php  echo str_replace('"', "", json_encode($data[0]->email)); ?>
                        <br>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-telephone-inbound-fill mr-3" viewBox="0 0 16 16">
                          ...
                          </svg><?php  echo str_replace('"', "", json_encode($data[0]->phone_number)); ?></p>
